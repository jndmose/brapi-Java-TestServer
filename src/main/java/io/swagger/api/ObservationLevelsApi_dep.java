...
public interface ObservationLevelsApi_dep {
    ...
    @ApiOperation(value = "<strong>Deprecated</strong> List observation levels", nickname = "observationLevelsGet", notes = " ** DEPRECTED ** Use /observationlevels Call to retrieve the list of supported observation levels. Observation levels indicate the granularity level at which the measurements are taken. The values are used to supply the `observationLevel` parameter in the observation unit details call. ", response = ObservationLevelsResponse.class, tags={ "Observations","Deprecated", })
    @ApiResponses(value = { 
